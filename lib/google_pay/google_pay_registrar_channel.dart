...
class GooglePayRegistrarChannel {
  ...
  static const BasicMessageChannel<String> _channel = BasicMessageChannel("google_pay_exchange", StringCodec());
  ...
  static Future<String> _mapExchangeResult(GooglePayExchangeResult result) async {
